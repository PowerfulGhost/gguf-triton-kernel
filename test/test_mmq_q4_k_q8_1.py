...
from kernels.mmq_q4_k_q8_1 import mmq_q4_k_q8_1
from kernels.cpu_impls.mmq_q4_k_q8_1_cpu import mmq_q4_k_q8_1_cpu
...
for M, N, K in mnk_list:
    ...
    quant_A = quantize_to_q4_k(float_A)
    quant_B = quantize_to_q8_1(float_B)

    C_cpu = mmq_q4_k_q8_1_cpu(quant_A, quant_B, M, N, K)
    C_triton = mmq_q4_k_q8_1(quant_A.to("cuda:0"), quant_B.to("cuda:0"), M, N, K)
