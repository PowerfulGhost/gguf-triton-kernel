...
from kernels.mmq_q8_0_new import mmq_q8_0 as mmq_q8_0_new
from kernels.cpu_impls.mmq_q8_0_cpu import mmq_q8_0_cpu
...
for M, N, K in mnk_list:
    ...
    quant_B = quantize_to_q8_0(float_B)

    C_cpu = mmq_q8_0_cpu(quant_A, quant_B, M, N, K)
    C_triton = mmq_q8_0(quant_A.to("cuda:0"), quant_B.to("cuda:0"), M, N, K)
